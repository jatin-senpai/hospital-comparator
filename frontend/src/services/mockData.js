...
export const HOSPITALS = [
  ...
  // Delhi Hospitals
  {
    ...
    image: 'max',
    services: {
      xray: { price: 400, duration: 15, available: true, report: '2 hrs' },
      mri: { price: 5000, duration: 45, available: true, report: '24 hrs' },
      ct: { price: 3500, duration: 30, available: true, report: '6 hrs' },
      blood: { price: 200, duration: 10, available: true, report: '6 hrs' },
      urine: { price: 130, duration: 5, available: true, report: '4 hrs' },
      ecg: { price: 300, duration: 20, available: true, report: '1 hr' },
      ultrasound: { price: 900, duration: 25, available: true, report: '2.5 hrs' },
      thyroid: { price: 700, duration: 10, available: true, report: '12 hrs' },
    },
  ...
  },
  {
    ...
    image: 'lallabs',
    services: {
      xray: { price: 300, duration: 15, available: true, report: '3 hrs' },
      mri: { price: 4800, duration: 50, available: true, report: '24 hrs' },
      ct: { price: 3000, duration: 35, available: true, report: '8 hrs' },
      blood: { price: 150, duration: 10, available: true, report: '8 hrs' },
      urine: { price: 100, duration: 5, available: true, report: '6 hrs' },
      ecg: { price: 200, duration: 20, available: true, report: '2 hrs' },
      ultrasound: { price: 700, duration: 30, available: true, report: '3 hrs' },
      thyroid: { price: 600, duration: 10, available: true, report: '12 hrs' },
    },
    slots: generateSlots(9),
  },
  // Mumbai Hospitals
  {
    ...
    image: 'lilavati',
    services: {
      xray: { price: 450, duration: 15, available: true, report: '2 hrs' },
      mri: { price: 5500, duration: 45, available: true, report: '24 hrs' },
      ct: { price: 4000, duration: 30, available: true, report: '6 hrs' },
      blood: { price: 250, duration: 10, available: true, report: '6 hrs' },
      urine: { price: 160, duration: 5, available: true, report: '4 hrs' },
      ecg: { price: 350, duration: 20, available: true, report: '1 hr' },
      ultrasound: { price: 1000, duration: 25, available: true, report: '2 hrs' },
      thyroid: { price: 800, duration: 10, available: true, report: '12 hrs' },
    },
    slots: generateSlots(8),
  },
  {
    ...
    image: 'suburban',
    services: {
      xray: { price: 380, duration: 15, available: true, report: '3 hrs' },
      mri: { price: 5100, duration: 50, available: true, report: '24 hrs' },
      ct: { price: 3600, duration: 35, available: true, report: '8 hrs' },
      blood: { price: 180, duration: 10, available: true, report: '8 hrs' },
      urine: { price: 120, duration: 5, available: true, report: '6 hrs' },
      ecg: { price: 250, duration: 20, available: true, report: '2 hrs' },
      ultrasound: { price: 800, duration: 30, available: true, report: '3 hrs' },
      thyroid: { price: 680, duration: 10, available: true, report: '12 hrs' },
    },
    slots: generateSlots(9),
  },
]
